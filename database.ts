  ...
  public: {
    Tables: {
      ai_recommendations: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_recommendations_delivery_id_fkey"
            columns: ["delivery_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "ai_recommendations_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "ai_recommendations_task_id_fkey"
            columns: ["task_id"]
            isOneToOne: false
      ...
      override_decisions: {
        Row: {
          ...
          status: Database["public"]["Enums"]["override_status"]
          updated_at: string
        }
        Insert: {
          created_at?: string
        ...
        Relationships: [
          {
            foreignKeyName: "override_decisions_overridden_by_user_id_fkey"
          ...
          {
            foreignKeyName: "override_decisions_recommendation_id_fkey"
      ...
      recommendation_feedback: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "recommendation_feedback_reviewer_user_id_fkey"
